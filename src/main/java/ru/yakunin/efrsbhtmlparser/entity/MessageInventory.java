...
public class MessageInventory {
    ...
    public String getInventoryInfoText() {
        return inventoryInfoText;
    }

    public void setInventoryInfoText(String inventoryInfoText) {
        this.inventoryInfoText = inventoryInfoText;
    }

    //here we need to download all attached files to each current message: in formats of PDF, EXCEL. WORD, JPEG
